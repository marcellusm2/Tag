<%@ page language="C#" debug="true" masterpagefile="~/Loja/MasterPage.master" autoeventwireup="true" inherits="vitrine, App_Web_7ay-scuk" title="Tag Computadores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container-corpo">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            ...
            SelectMethod="ListarVitrine" 
            TypeName="DSTagTableAdapters.TbProdutoTableAdapter"></asp:ObjectDataSource>
        ...
        <asp:DataList ID="DataList1" runat="server" DataKeyField="id" 
            ...
            <asp:Label ID="TitleLabel" runat="server" Text='<%# Eval("nome_produto") %>'></asp:Label></td>
                ...
                <tr>
                    <td>
            <asp:Label ID="PriceLabel" runat="server" Text='<%# Eval("valor_produto", "{0:C}") %>' CssClass="valor"></asp:Label></td>
                </tr>
            </table>
            </ItemTemplate>
        </asp:DataList>
